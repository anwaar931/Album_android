...
/**
 * Created by Anwaar on 31/03/2014.
 */
public class GoogleDrive extends Activity implements ConnectionCallbacks, OnConnectionFailedListener,View.OnClickListener
{
...
/**
 ...
 /*private void storeAllDriveFiles(Drive service) {
    ...
    ImageButton btn_drive;
 @Override
 protected void onCreate(Bundle savedInstanceState) {
     super.onCreate(savedInstanceState);
     setContentView(R.layout.google_drive);
     btn_drive=(ImageButton) findViewById(R.id.image_camera_drive);
